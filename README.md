# Zerk-Play
Zerk Play is a Flutter based couch-friendly Emby desktop client with built-in *seerr request integration.
...
Join the Discord server to provide feedback and suggestions

[![Discord](https://img.shields.io/badge/Discord-%235865F2.svg?style=for-the-badge&logo=discord&logoColor=white)](https://discord.gg/GnqY9z6zry)
...
MPV Play with easy to use UI (Skip Intro and Autoplay for next episodes are available)
